...
export const PASSIVE_LIBRARY = {
  'siccita': {
    name:     'Siccità',
    effect:   "Mosse di tipo Fuoco: +25% di danno inflitto.",
    slotPool: ['back-center', 'back-left', 'back-right', 'front-center'],
    meta:     {"kind": "type_boost", "type": "fire", "mult": 1.25},
  },
  'pioggerellina': {
    name:     'Pioggerellina',
    effect:   "Mosse di tipo Acqua: +25% di danno inflitto.",
    slotPool: ['back-center', 'back-left', 'back-right', 'front-center'],
    meta:     {"kind": "type_boost", "type": "water", "mult": 1.25},
  },
  'sabbiainfinita': {
    name:     'Sabbiainfinita',
    effect:   "Mosse di tipo Roccia e Terra: +20% di danno inflitto.",
    slotPool: ['back-center', 'back-left', 'back-right', 'front-center'],
    meta:     {"kind": "type_boost_multi", "types": ["rock", "ground"], "mult": 1.2},
  },
  'snownevicata': {
    name:     'Scendineve',
    effect:   "Mosse di tipo Ghiaccio: +25% di danno inflitto.",
    slotPool: ['back-center', 'back-left', 'back-right', 'front-center'],
  ...
  'multiscala': {
    name:     'Multiscaglia',
    effect:   "Se sei a HP pieni, il primo colpo che subisci fa il -50% di danno.",
    slotPool: ['front-center', 'front-left', 'front-right'],
    meta:     {"kind": "first_hit_resist", "amount": 0.5, "condition": "full_hp"},
  },
  'vigore': {
    name:     'Vigore',
    effect:   "Una volta a battaglia, sopravvivi con 1 HP a un colpo che ti stenderebbe.",
    slotPool: ['front-center', 'front-left', 'front-right'],
  ...
  'pressione': {
    name:     'Pressione',
    effect:   "Chi ti attacca consuma 1 PP in più del normale.",
    slotPool: ['front-center', 'front-left', 'front-right'],
    meta:     {"kind": "extra_pp_cost", "amount": 1},
  },
  'tecnico': {
    name:     'Tecnico',
    effect:   "Mosse Base (non Finisher): +30% di danno inflitto.",
    slotPool: ['front-center', 'front-left', 'front-right', 'back-center'],
    meta:     {"kind": "base_move_boost", "mult": 1.3},
  },
  'fortunone': {
    name:     'Fortunone',
    effect:   "Mosse Finisher: +20% di danno inflitto.",
    slotPool: ['back-center', 'back-left', 'back-right'],
  ...
  'statico': {
    name:     'Statico',
    effect:   "Chi ti attacca ha il 30% di probabilità di non guadagnare PP quel turno.",
    slotPool: ['front-center', 'front-left', 'front-right'],
    meta:     {"kind": "pp_block_chance", "chance": 0.3},
  },
  'velenpunta': {
    name:     'Velenpunta',
    effect:   "Mosse di tipo Veleno: +25% di danno inflitto.",
    slotPool: ['back-center', 'back-left', 'back-right', 'front-center'],
  ...
  'velocitascatto': {
    name:     'Velocitàscatto',
    effect:   "Ogni turno la tua Velocità sale del 15%, cumulativo fino a +60%.",
